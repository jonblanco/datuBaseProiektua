...
public class eragiketakUserAdmin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					eragiketakUserAdmin frame = new eragiketakUserAdmin();
	...
	public eragiketakUserAdmin() {
		...
		btnNewButton.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/persona.png")));
		...
		btnErabiltzailea.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/shield_1.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/logo.png")));
		...
		btnErabiltzailea_1.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/equipo.png")));
		...
		btnErabiltzailea_1_1.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/trofeo.png")));
		...
		btnErabiltzailea_1_1_1.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/icons8_Clock_96px.png")));
		...
		btnErabiltzailea_1_1_2.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/icons8_User_96px_2.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(eragiketakUserAdmin.class.getResource("/images/icons8_Back_64px.png")));
